...
public class AppModule
{
	...
	public static DatabaseService buildDatabaseService(CayenneService cayenneService)
    {
    	return new DatabaseServiceImpl(cayenneService);
    }
    
    public static UserAccountService buildUserAccountService(
    		@Inject CayenneService cayenneService)
    	{
    		return new UserAccountServiceImpl(cayenneService);
    	}
    ...
    public static void addRealm(Configuration<Realm> configuration, @Inject CayenneService cs, 
    	@Inject UserAccountService uas)
    {
    	LocalSecurityRealm localSecurityRealm = new LocalSecurityRealm(cs, uas);
