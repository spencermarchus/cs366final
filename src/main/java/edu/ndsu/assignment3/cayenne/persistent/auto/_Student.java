...
import edu.ndsu.assignment3.cayenne.persistent.Enrollment;
import edu.ndsu.assignment3.cayenne.persistent.Guardianship;
...
public abstract class _Student extends CayenneDataObject {
    ...
    public static final Property<List<Guardianship>> GUARDIANSHIP = Property.create("guardianship", List.class);
    ...
    public void addToGuardianship(Guardianship obj) {
        addToManyTarget("guardianship", obj, true);
    }
    public void removeFromGuardianship(Guardianship obj) {
        removeToManyTarget("guardianship", obj, true);
    }
    @SuppressWarnings("unchecked")
    public List<Guardianship> getGuardianship() {
        return (List<Guardianship>)readProperty("guardianship");
    }
